...
import Feature_Banner from "../assets/Feature_Banner.png";
          ...
          <div className="flex flex-col md:flex-row justify-between py-16 md:py-32 items-center md:items-start gap-12 md:gap-0">
            ...
            <div className="w-full md:w-[562px] text-white text-center md:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-[54px] font-semibold leading-snug md:leading-[74px] pb-6">
                All the features <span className='block'>you need</span>
              </h1>
              <p className="max-w-md mx-auto md:mx-0 mb-8">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do <span className='block'>eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
              </p>
            ...
            <div className="w-full md:w-auto">
              <img src={Feature_Banner} alt="Banner" className="mx-auto md:mx-0 max-w-full h-auto" />
            </div>
          </div>
        </div>
      </div>
